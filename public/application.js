...
var config = {
  apiOrigins: {
    ...
    production: 'https://gentle-woodland-80342.herokuapp.com',
...
var cart = __webpack_require__(25);

// order history
var showAllOrders = function showAllOrders(data) {
  return $.ajax({
...
var ordersAPI = __webpack_require__(4);
var stripeEvents = __webpack_require__(8);

var showProductsTemplate = __webpack_require__(43);
var showCartTemplate = __webpack_require__(44);
var showCheckoutTemplate = __webpack_require__(45);
...
// cart array.
var onAddItemToCartArray = function onAddItemToCartArray(event) {
...
var removeFromCartArray = function removeFromCartArray(event) {
  if (store.cart.length === 1) {
    store.cart = [];
    var data = store.currentOrder;
    ordersAPI.deleteOrder(data).then(stripeEvents.createNewCart).then(pushItemsToCart);
  } else {
    var newCart = store.cart.filter(function (item) {
...
var populateCheckout = function populateCheckout(event) {
  event.preventDefault();
  $('#totalMoneySuckerPays').empty();
  store.total = 0;
  var filteredData = productData.products.filter(function (item) {
    for (var i = 0; i < store.cart.length; i++) {
...
var pushItemsToCart = function pushItemsToCart() {
  ...
  var showCartHTML = showCartTemplate({ products: filteredData });
...
var showAllProductsSuccess = function showAllProductsSuccess(data) {
  store.products = data.products;
  var showProductsHTML = showProductsTemplate({ products: data.products });
  $('#productTable').show();
...
var showAllProductsFailure = function showAllProductsFailure() {}
...
;var carriageBoy = function carriageBoy() {
  if (!store.currentOrder) {
    ...
    api.createNewCart(data).then(ui.onCreateNewCartSuccess).catch(ui.onCreateNewCartFailure);
  }
};

var updateExistingCart = function updateExistingCart() {
  var id = store.currentOrder.id;
  ...
  api.finalizeOrder(data, id).then(onUpdateExisitingCartSuccess).catch(onUpdateExisitingCartFailure);
};
var onUpdateExisitingCartSuccess = function onUpdateExisitingCartSuccess() {
  $('#UiSuccess').text('Your cart has been updated').fadeIn('fast').delay(3000).fadeOut('slow');
};
var onUpdateExisitingCartFailure = function onUpdateExisitingCartFailure() {
  $('#UiFailure').text('Oops! Something went wrong!').fadeIn('fast').delay(3000).fadeOut('slow');
};
module.exports = {
  showAllProductsSuccess: showAllProductsSuccess,
  showAllProductsFailure: showAllProductsFailure,
  carriageBoy: carriageBoy,
  pushItemsToCart: pushItemsToCart
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var store = __webpack_require__(1);
var ordersApi = __webpack_require__(4);
var ordersUi = __webpack_require__(9);
...
var onFinalizeOrder = function onFinalizeOrder() {
  var date = new Date();
  var id = store.currentOrder.id;
  var proof = store.proofOfSale;
  var data = {
    'order': {
      'salesProof': {
        'id': proof.id,
  ...
  api.finalizeOrder(data, id).then(ui.onFinalizePaymentSuccess).then(ordersApi.showAllOrders).then(ordersUi.showAllOrdersSuccess).catch(ui.onFinalizePaymentFailure);
};
...
var handleToken = function handleToken(token) {
  ...
  // on success
  .then(ui.onStripeAPISuccess).then(onFinalizeOrder).then(createNewCart).catch(ui.onStripeAPIFail);
};

var shutUpAndTakeMyMoney = function shutUpAndTakeMyMoney(event) {
...
var showOrdersTemplate = __webpack_require__(26);
var store = __webpack_require__(1);

var orderHistoryHandlebarsArrayDeluxe = [];
// refines the past order data

var cleanRyansFunction = function cleanRyansFunction(order) {
...
var showAllOrdersSuccess = function showAllOrdersSuccess(data) {
  store.orders = data.orders;
  store.orders.forEach(cleanRyansFunction);

  var showOrdersHTML = showOrdersTemplate({ orders: orderHistoryHandlebarsArrayDeluxe });
  $('#previousOrderTable tbody').empty();
  $('#previousOrderTable tbody').append(showOrdersHTML);
  orderHistoryHandlebarsArrayDeluxe = [];
};

var showAllOrdersFailure = function showAllOrdersFailure() {};

var addOrderSuccess = function addOrderSuccess() {};
var addOrderFailure = function addOrderFailure() {};

var updateOrderSuccess = function updateOrderSuccess(data) {};
var updateOrderFailure = function updateOrderFailure() {};
var deleteOrderSuccess = function deleteOrderSuccess(data) {};

var deleteOrderFailure = function deleteOrderFailure(data) {};

module.exports = {
  showAllOrdersSuccess: showAllOrdersSuccess,
  showAllOrdersFailure: showAllOrdersFailure,
  addOrderSuccess: addOrderSuccess,
  addOrderFailure: addOrderFailure,
...
var makeCharge = function makeCharge(data) {
  return $.ajax({
...
var finalizeOrder = function finalizeOrder(data, id) {
  return $.ajax({
...
var createNewCart = function createNewCart(data) {
  return $.ajax({
    url: config.apiOrigin + '/orders',
    method: 'POST',
    headers: {
...
var onStripeAPISuccess = function onStripeAPISuccess(data) {
  store.proofOfSale = {
    'id': data.id,
...
// on failed response
var onStripeAPIFail = function onStripeAPIFail(data) {};
var onFinalizePaymentSuccess = function onFinalizePaymentSuccess() {
  $('#UiSuccess').text('Thank you for your purchase!').fadeIn('fast').delay(3000).fadeOut('slow');
};

var onFinalizePaymentFailure = function onFinalizePaymentFailure() {
  // stripe api fail does not reach this function
};

var onCreateNewCartSuccess = function onCreateNewCartSuccess(data) {
...
var onCreateNewCartFailure = function onCreateNewCartFailure() {};

module.exports = {
  onStripeAPISuccess: onStripeAPISuccess,
  onStripeAPIFail: onStripeAPIFail,
  onCreateNewCartSuccess: onCreateNewCartSuccess,
  onCreateNewCartFailure: onCreateNewCartFailure,
  onFinalizePaymentSuccess: onFinalizePaymentSuccess,
  onFinalizePaymentFailure: onFinalizePaymentFailure
...
var showAllProducts = function showAllProducts() {
  return $.ajax({
...
var setAPIOrigin = __webpack_require__(20);
var config = __webpack_require__(3);
var authEvents = __webpack_require__(22);
var orderEvents = __webpack_require__(46);
var productEvents = __webpack_require__(47);
var stripeEvents = __webpack_require__(8);
...
var parseNestedQuery = __webpack_require__(21);
...
var productsApi = __webpack_require__(16);
var productsUi = __webpack_require__(7);
var ordersApi = __webpack_require__(4);
var ordersUi = __webpack_require__(9);
var store = __webpack_require__(1);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).then(ui.signInSuccess).catch(ui.signInFailure).then(productsApi.showAllProducts).then(productsUi.showAllProductsSuccess).then(ordersApi.showAllOrders).then(ordersUi.showAllOrdersSuccess).then(productsUi.carriageBoy).catch(productsUi.showAllProductsFailure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- this is the handlebars for products when the page loads. Products will\nbe displayed, through this mechanism, on the landingPage -->\n<tr>\n\n <td><p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_placed : stack1), depth0))
    + "</p></td>\n <!-- set up modal here -->\n <td><ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.products : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + " <td><p>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total : stack1), depth0))
    + "</p></td>\n\n\n\n\n<!-- Add to cart form with a hidden input that contains the order id and an input\nfor quanity. When submitted, this form will trigger a function to add the\nitem with the specified quanity to the shopping cart -->\n</tr>\n\n\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- this is the handlebars for products when the page loads. Products will\nbe displayed, through this mechanism, on the landingPage -->\n<tr>\n\n<td><img class=\"thumbnail\" src="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.img_url : stack1), depth0))
    + "></img></td>\n <td><p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</p></td>\n <td><p>$"
    ...
    + " Glarbles</p></td>\n\n\n<!-- Add to cart form with a hidden input that contains the product id and an input\nfor quanity. When submitted, this form will trigger a function to add the\nitem with the specified quanity to the shopping cart -->\n\n<td>\n  <form class=\"addToCart\">\n    <fieldset>\n      <input min=\"1\" max=\"999\" class='text-field' type=\"number\" name='quantity' value=\"1\">\n      <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class='text-field' type=\"hidden\" name='id'><br> <br>\n      <input value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class='text-field' type=\"hidden\" name='price'><br> <br>\n      <button class=\"btn btn-primary btn-lg\" type=\"submit\">Add to Cart</button>\n    </fieldset><br>\n    <div></div>\n  </form>\n\n\n</td>\n</tr>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- this is the handlebars for products when the page loads. Products will\nbe displayed, through this mechanism, on the landingPage -->\n<tr>\n\n<td><img class=\"thumbnail\" src="
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1), depth0))
    + "</p></td>\n <td><p>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.subtotal : stack1), depth0))
    + "</p></td>\n\n\n\n<!-- Add to cart form with a hidden input that contains the product id and an input\nfor quanity. When submitted, this form will trigger a function to add the\nitem with the specified quanity to the shopping cart -->\n\n<td>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"removeFromCart btn btn-primary btn-lg\" type=\"submit\">Remove From Cart</button>\n</td>\n</tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var onAddOrder = function onAddOrder(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addOrder(data).then(ui.addOrderSuccess).catch(ui.addOrderFailure);
};

var onShowAllOrders = function onShowAllOrders(event) {
  event.preventDefault();
  // api.showAllOrders()
...
// sign in
var onShowAllProducts = function onShowAllProducts(event) {
  event.preventDefault();
  api.showAllProducts().then(ui.showAllProductsSuccess).catch(ui.showAllProductsFailure);
};

var onProductsMenuButton = function onProductsMenuButton() {
  $('.landingPage').show();
  $('#productTable').show();
  $('#cartPage').hide();
  $('#checkoutPage').hide();
...
var onOrderHistoryButton = function onOrderHistoryButton() {
  $('.landingPage').hide();
  $('#cartPage').hide();
  $('#checkoutPage').hide();
...
var onShoppingCartMenuButton = function onShoppingCartMenuButton() {
  $('.landingPage').hide();
  $('#cartPage').show();
  $('#checkoutPage').hide();
  $('.previousOrderList').hide();
...
var onCheckoutMenuButton = function onCheckoutMenuButton() {
  $('.landingPage').hide();
  $('#cartPage').hide();
  $('#checkoutPage').show();
};

var onBackToCartButton = function onBackToCartButton() {
  $('.landingPage').hide();
  $('#cartPage').show();
  $('#checkoutPage').hide();
};
...
var onClearCart = function onClearCart() {
  store.cart = [];
  var data = store.currentOrder;
  ordersAPI.deleteOrder(data).then(stripeEvents.createNewCart).then(ui.pushItemsToCart);
};

var onBackToShopping = function onBackToShopping() {
  $('.landingPage').show();
  $('#productTable').show();
  $('#cartPage').hide();
  $('#checkoutPage').hide();
